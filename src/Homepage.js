		...
		<ThemeProvider theme={theme}>
			...
			<div className="Carpet">
				...
				<div>
					<div className="center">
						...
						<Box sx={{ backgroundColor: 'black', width:'50%', margin:'auto'}}>
							<p>I'm a 27-year-old full-stack developer who uses JavaScript with React. (It's how I built this website!) I also have experience working in fast-paced IT support both with a ticket queue and in realtime, and I love to design and program video games!</p>
				...
				<footer className="center">
					...
					<a style={{color:"red"}} href="https://itch.io/CASEYGUNGEON" title='itch.io'><StorefrontIcon style={{fontSize: 50}}/></a>
